/*
================================================================================
  Styles Configuration File for Resume Maker Project
================================================================================

This file contains **all the TailwindCSS utility class configurations** used
across the React application. Instead of hardcoding long Tailwind classes in
components, this file centralizes styles for maintainability, consistency,
and readability.

Structure:

1. landingPageStyles
   - Styles for the landing page, including header, hero, features, CTA,
     footer, buttons, and hero illustration.

2. dashboardStyles
   - Styles for the dashboard page: header, create button, grid layout,
     cards, modals, empty state, and loading spinner.

3. cardStyles
   - Styles for reusable cards such as ProfileInfoCard, ResumeSummaryCard,
     TemplateCard, including hover and action effects.

4. authStyles
   - Styles for authentication forms (login/signup), buttons, and switch
     links.

5. Form Section Styles
   - additionalInfoStyles, certificationInfoStyles, contactInfoStyles,
     educationDetailsStyles, profileInfoStyles, projectDetailStyles,
     skillsInfoStyles, workExperienceStyles
   - Styles for individual form sections with background, padding, borders,
     buttons, and text inputs.

6. Common & Reusable Styles
   - commonStyles, buttonStyles, statusStyles, iconStyles, inputStyles,
     photoSelectorStyles, titleInputStyles, modalStyles, infoStyles
   - General-purpose styling for buttons, inputs, modals, icons, progress bars,
     action links, and other reusable components.

7. shimmerStyle
   - Contains keyframe animations (shimmer, flow, bubble, pulse-glow) used
     for visual effects in loading states or interactive UI elements.

Purpose:
- Keep JSX components clean and readable.
- Ensure consistent UI design across pages and components.
- Centralized maintenance for colors, gradients, spacing, typography,
  buttons, cards, modals, and animations.
- Facilitates theme updates and quick modifications.
