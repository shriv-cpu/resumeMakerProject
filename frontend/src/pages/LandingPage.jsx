            ...
            <div className={landingPageStyles.ctaCard}>
              ...
              <div className={landingPageStyles.ctaCardContent}>
                ...
                <p className={landingPageStyles.ctaDescription}>
                  Join thousand od professional who landed their dream jobs regards platform

                </p>
                <button className={landingPageStyles.ctaButton} onClick={handleCTA}>
                  <div className={landingPageStyles.ctaButtonOverlay}></div>
                  <span className={landingPageStyles.ctaButtonText}> start building
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
          <p className={landingPageStyles.footerText}>
            Crafted with <span className={landingPageStyles.footerHeart}>❤</span> by{' '}
            <a href="https://www.linkedin.com/in/shrivardhan-vishwakarma-159a0b335/" target='_blank' className={landingPageStyles.footerLink}>
              Shrivardhan
            </a>
          </p>
        </div>
